package org.example.advancedproblems.encryptanddecryptCSVdata;
...
public class EncryptAndDecrypt {
    ...
    public static void main(String[] args) {
        String filePath = "src/main/java/org/example/advancedproblems/encryptanddecryptCSVdata/question15.csv";
        writeToCSV(filePath);
